...
const EditNotitaGroupItem = ({ item, setGestioneazaParolaItem }) => {
                        ...
                        <div className="grid sm:grid-cols-2 lg:gap-x-36 grid-cols-1 gap-6 mt-6">
                            <div className="flex flex-col">
                                <div className="flex flex-row">
                                    ...
                                    <button onClick={() => setdeEditat({ ...deEditat, date: !deEditat.date })} className="ml-2 text-gray-500 hover:text-blue-500 transition">
...
export default EditNotitaGroupItem;
    ...
    return (
        <>
            <div className="bg-gray-100">
                <h2 className="font-bold text-2xl text-center mt-6">Notițele mele</h2>
                ...
                <hr className="border-t-3 border-gray-500 my-4 rounded-full mx-12" />            </div>
        </>
    );
};

export default NotitePage;
